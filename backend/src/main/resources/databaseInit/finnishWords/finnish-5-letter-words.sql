...
('rasva'), ('ratas'), ('ratki'), ('ratsu'), ('ratti'), ('ratto'), ('rauha'), ('rauta'), ('rautu'), ('ravet'),
('ravit'), ('reeti'), ('rehti'), ('reiki'), ('reikä'), ('reilu'), ('reima'), ('reisi'), ('reivi'), ('rekka'),
('rekki'), ('reksi'), ('remmi'), ('renki'), ('rento'), ('repiä'), ('reppu'), ('repro'), ('reput'), ('respa'),
('ressu'), ('reteä'), ('retki'), ('retku'), ('retro'), ('reuma'), ('reuna'), ('revyy'), ('ribbi'), ('rieha'),
('riemu'), ('riena'), ('riepu'), ('riesa'), ('rievä'), ('riffi'), ('rihla'), ('rihma'), ('riihi'), ('riimi'),
('riimu'), ('riisa'), ('riisi'), ('riita'), ('riite'), ('riiuu'), ('rikas'), ('rikka'), ('rikki'), ('rikko'),
('rikos'), ('riksa'), ('riksi'), ('rimpi'), ('rimsu'), ('rinki'), ('rinne'), ('rinta'), ('ripeä'), ('rippi'),
('rippu'), ('ripsi'), ('ripsu'), ('riski'), ('risoa'), ('risti'), ('ritsa'), ('ritva'), ('riuku'), ('riuna'),
('rodeo'), ('rohea'), ('rohjo'), ('rohmu'), ('rohto'), ('roihu'), ('roilo'), ('roima'), ('roina'), ('roipe'),
('roisi'), ('rokka'), ('rokki'), ('rokko'), ('rombi'), ('rommi'), ('rompe'), ('rondi'), ('rondo'), ('rooli'),
('roosa'), ('ropse'), ('rosee'), ('roska'), ('rosmo'), ('rosti'), ('rosvo'), ('rotko'), ('rotsi'), ('rotta'),
('rouhe'), ('routa'), ('rouva'), ('rovio'), ('rugby'), ('ruhje'), ('rukka'), ('rukki'), ('ruksi'), ('rulla'),
('rumba'), ('rumpu'), ('rundi'), ('runko'), ('ruode'), ('ruoho'), ('ruoja'), ('ruoka'), ('ruoko'), ('ruori'),
('ruoti'), ('ruoto'), ('ruotu'), ('rupia'), ('rupla'), ('ruska'), ('rusko'), ('rusto'), ('rutka'), ('rutto'),
('ruttu'), ('ruuhi'), ('ruuma'), ('ruuna'), ('ruusu'), ('ruuti'), ('ruutu'), ('ruuvi'), ('ryhmy'), ('ryhmä'),
('ryhti'), ('ryijy'), ('rykiä'), ('ryntö'), ('ryppy'), ('rypsi'), ('rypäs'), ('ryske'), ('rysty'), ('rytke'),
('rytky'), ('rytmi'), ('ryväs'), ('ryyni'), ('ryysy'), ('ryyti'), ('ryönä'), ('rähjä'), ('rähmä'), ('räike'),
('räime'), ('räkiä'), ('räkki'), ('räkkä'), ('räksä'), ('rämeä'), ('ränni'), ('räntä'), ('räppi'), ('räpse'),
('rästi'), ('rätti'), ('rääsy'), ('räävi'), ('röhnä'), ('rölli'), ('römeä'), ('rönsy'), ('rösti'), ('rötös'),
('röyhy'), ('rööki'), ('rööri');
